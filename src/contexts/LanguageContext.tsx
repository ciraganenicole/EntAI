...
const translations = {
  fr: {
    ...
    'footer.rights': '© 2025 TijaBoost. Tous droits réservés.',
    ...
    'footer.cookies': 'Politique des cookies',
     ...
     'survey.back': 'Précédent',
     'survey.next': 'Suivant',
     'survey.frequence.placeholder': 'Sélectionnez la fréquence',
  ...
  en: {
    ...
    'footer.support': 'Support',
    'footer.contact': 'Contact',
    'footer.rights': '© 2025 TijaBoost. All rights reserved.',
    ...
    'survey.back': 'Back',
    'survey.next': 'Next',
    'survey.frequence.placeholder': 'Select frequency',
